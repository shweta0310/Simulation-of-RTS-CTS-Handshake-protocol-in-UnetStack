...
class MySimpleHandshakeMac extends UnetAgent {
  ...
  private FSMBehavior fsm = FSMBuilder.build {
	...
	//new_data="CTS"
	//phy << new DatagramReq(to: msg.to, protocol: PROTOCOL, data: msg.data)
        after(msg.duration) {
  ...
  void processMessage(Message msg) {
	...
	received_data = msg.data[0];
      ...
      send new DatagramReq(recipient: msg.sender,to: msg.from, protocol: Protocol.USER, data: new_data)
    }
